        ...
        <tbody>
          ...
          ?>
            ...
            if ($value->vendor_id_accepted == 0 && $value->proposal_completed==0 && ($value->buy_status=='undone' || $value->buy_status=='proposal')) {
              ...
              <button type="button" class="btn btn-warning btn" onclick="clickModal(<?php echo $user_id; ?>,<?php echo $value->order_id; ?>,<?php echo $value->product_id; ?>,<?php echo $value->order_product_id; ?>,<?php echo ($value->order_product_quantity * $value->order_product_price * $value->order_product_tax);?>,<?php echo $value->order_product_quantity; ?>)">تغییر محصول</button>
             <?php
              echo "</td>";
