...
$document->addScript('http://fishopping.ir/search/scripts/custom.js"');
...
var counter =0;
  ...
  function insertSearchInput(){
    ...
    counter++;
      ...
      <input type="text" id="search" class="form-control searching searChInput" style=" padding:18px 22px !important" aria-label="Amount (to the nearest dollar)">
